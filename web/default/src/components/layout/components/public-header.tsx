...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  if (loading) {
    ...
    brandLogo = customLogo as React.ReactElement;
  } else if (isHuichuanBrand(displaySiteName)) {
    brandLogo = <BrandMark className="size-full" />;
  }
  ...
  if (loading) {
    authAction = <Skeleton className="h-8 w-20 rounded-lg" />;
          ...
          >
            ...
            >
              ...
              {loading ? (
                ...
                <BrandWordmark name={displaySiteName} className="text-sm" />
              )}
            </Link>
