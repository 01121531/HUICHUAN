...
export function PanelWrapper(props: PanelWrapperProps) {
  ...
  const frameClassName = cn(
    'border-border/60 bg-card/85 overflow-hidden rounded-2xl border shadow-sm transition-[border-color,box-shadow] duration-300 hover:border-violet-500/20 hover:shadow-md',
    props.className
  )
